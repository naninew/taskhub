...
from app.api.v1.deps import get_label_service
...
async def create_label(
    ...
    return await service.create_label(project_id=project_id, label_in=label_in)
...
async def list_labels(
    ...
    return await service.list_labels(project_id=project_id)
...
async def get_label(
    ...
    return await service.get_label(project_id=project_id, label_id=label_id)
...
async def update_label(
    ...
    return await service.update_label(
        project_id=project_id, label_id=label_id, label_in=label_in
    )
...
async def delete_label(
    ...
    await service.delete_label(project_id=project_id, label_id=label_id)
